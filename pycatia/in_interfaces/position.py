...
class Position(Move):
    ...
    def get_abs_components(self) -> tuple:
        ...
        .. note::
            ...
            CAA V5 Visual Basic Help (2020-07-06 14:02:20.222384))
                | o Sub GetAbsComponents(CATSafeArrayVariant
                | oAxisComponentsArray)
                |
                |     Returns the components of an object's position. This returns the 3D-axis
                |     system associated with the object.
                ...
                |
                |          Dim oAxisComponentsArray ( 11 )
                |          MyObject.Position.GetAbsComponents oAxisComponentsArray

        :return: tuple
        :rtype: tuple
        """
        vba_function_name = 'get_abs_components'
        vba_code = """
        Public Function get_abs_components(position)
            Dim oAxisComponentsArray(11)
            position.GetAbsComponents oAxisComponentsArray
            get_abs_components = oAxisComponentsArray
        End Function
        """
    ...
    def set_abs_components(self, i_axis_components_array: tuple) -> None:
        ...
        .. note::
            ...
            CAA V5 Visual Basic Help (2020-07-06 14:02:20.222384))
                | o Sub SetAbsComponents(CATSafeArrayVariant
                | iAxisComponentsArray)
                |
                |     Sets the components of an object's position. This sets the 3D-axis system
                |     associated with the object.
                ...
                |          iAxisComponentsArray( 10 ) = 2.000
                |          iAxisComponentsArray( 11 ) = 3.000
                |          MyObject.Position.SetAbsComponents iAxisComponentsArray

        :param tuple i_axis_components_array:
        :return: None
        :rtype: None
        """
        return self.position.SetAbsComponents(i_axis_components_array)
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
        # # vba_function_name = 'set_abs_components'
        # # vba_code = """
        # # Public Function set_abs_components(position)
        # #     Dim iAxisComponentsArray (2)
        # #     position.SetAbsComponents iAxisComponentsArray
        # #     set_abs_components = iAxisComponentsArray
        # # End Function
        # # """
