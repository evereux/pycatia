...
class ManufacturingSetup(ManufacturingActivity):
    ...
    def list_design_geometries(self) -> tuple:
        """
        .. note::
            :class: toggle
    ...
    def list_design_geometries_products(self) -> tuple:
        """
        .. note::
            :class: toggle
    ...
    def list_fixture_geometries(self) -> tuple:
        """
        .. note::
            :class: toggle
        ...
        :rtype: tuple
        """
        return self.manufacturing_setup.ListFixtureGeometries(tuple)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def list_fixture_geometries_products(self, o_list_of_fixture_geometries_products: tuple) -> tuple:
        """
        .. note::
            :class: toggle
    ...
    def list_in_process_model_bodies(self) -> tuple:
        """
        .. note::
            :class: toggle
        ...
        :rtype: tuple
        """
        return self.manufacturing_setup.ListInProcessModelBodies()
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def list_stock_geometries(self) -> tuple:
        """
        .. note::
            :class: toggle
        ...
        :rtype: tuple
        """
        return self.manufacturing_setup.ListStockGeometries()
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def list_stock_geometries_products(self) -> tuple:
        """
        .. note::
            :class: toggle
