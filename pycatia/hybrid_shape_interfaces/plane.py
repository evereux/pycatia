...
class Plane(HybridShape):
    ...
    def get_first_axis(self) -> tuple[float,float,float]:
        ...
        """
        vba_function_name: str = 'wrapper_get_first_axis'
        vba_code: str = f"""Public Function {vba_function_name}(oPlane As Plane)
    ...
    def get_origin(self) -> tuple[float, float, float]:
        ...
        :rtype: tuple[float, float, float]
        """
        vba_function_name: str = 'wrapper_get_origin'
        vba_code: str = f"""Public Function {vba_function_name}(oPlane As Plane)
                Dim aReturn(2) As Variant
    ...
    def get_position(self) -> tuple[float, float, float]:
        ...
        :rtype: tuple[float, float, float]
        """
        vba_function_name: str = 'wrapper_get_position'
        vba_code: str = f"""Public Function {vba_function_name}(oPlane As Plane)
                        Dim aReturn(2) As Variant
                        x_pos = 0.0
                        y_pos = 0.0
    ...
    def get_second_axis(self) -> tuple[float,float,float]:
        ...
        :rtype: tuple[float,float,float]
        """
        vba_function_name: str = 'wrapper_get_second_axis'
        vba_code: str = f"""Public Function {vba_function_name}(oPlane As Plane)
        Dim aReturn(2) As Variant
