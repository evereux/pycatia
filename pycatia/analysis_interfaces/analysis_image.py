...
class AnalysisImage(AnyObject):
    ...
    def set_activation_status(self, i_activation_status: cat_variant) -> None:
        ...
        :rtype: None
        """
        return self.analysis_image.SetActivationStatus(i_activation_status.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def set_current_occurrence(self, i_occurrence_number: cat_variant) -> None:
        ...
        :rtype: None
        """
        return self.analysis_image.SetCurrentOccurrence(i_occurrence_number.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
