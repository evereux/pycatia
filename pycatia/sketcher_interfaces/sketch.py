...
from .factory2d import Factory2D
    ...
    """
        .. note::
            CAA V5 Visual Basic help
                ...
                | elements.The Sketch is created by giving a 2D support.
    ...
    def absolute_axis(self):
        ...
        .. note::
            CAA V5 Visual Basic help
                ...
                | AbsoluteAxis
                | o Property AbsoluteAxis(    ) As Axis2D
                | 
                | Returns the 2D absolute axis of the sketch. The absolute axis is used
                | for constraining the sketch in 3D space, and its constituting
                | horizontal and vertical directions can also be used to constrain
                | horizontally or vertically subsequent geometrical elements in the
                | sketch.  Returns:  oAxis   The absolute axis of the sketch (@see
                | CATIAAxis2D for more information). Example:The following example
                | places in myAxis the absolute axis of the sketch mySketch:  Set myAxis
                | = mySketch.AbsoluteAxis
    ...
    def center_line(self):
        ...
        .. note::
            CAA V5 Visual Basic help
                ...
                | 
                | Returns the geometric 2D line defined as the center line of the
                | sketch. Center lines are then used for creating shafts.  Returns:
                | oLine   The center line of the sketch(@see CATIALine2D for more
                | information). Example:The following example returns in myCenterLine
                | the center line in the sketch mySketch:  Set myCenterLine =
                | mySketch.CenterLine
    ...
    def constraints(self):
        ...
        .. note::
            CAA V5 Visual Basic help
                ...
                | 
                | Returns the list of constraints included in the sketch.  Returns:
    ...
    def factory2_d(self):
        ...
        .. note::
            CAA V5 Visual Basic help
                ...
                | Factory2D
                | o Property Factory2D(    ) As Factory2D
                | 
                | Returns the 2D factory of the sketch.  Take care that you must open
                | edition on a sketch before adding or modifying elements in it.
                | Returns:  oFactory   The 2D geometrical factory of the sketch (@see
                | CATIAFactory2D   for more information). Example:The following example
                | returns in my2DFactory the 2D factory of the sketch mySketch:  Set
                | my2DFactory = mySketch.Factory2D
    ...
    def geometric_elements(self):
        ...
        .. note::
            CAA V5 Visual Basic help
                ...
                | sketch (@see CATIAGeometricElements   for more information).
                | Example:The following example returns in colGeometry the list of
                | geometrical elements in the sketch mySketch:  Set colGeometry =
                | mySketch.GeometricElements
    ...
    def close_edition(self):
        ...
        .. note::
            CAA V5 Visual Basic help
                ...
                | o Sub CloseEdition(    )
                | 
                | Closes the Sketch Edition. Once you have finished working with the
                | sketch, you  must close its edition before using it for sketch-based
                | shapes.
                |
                | Example:
                | The following example closes the edition of the sketch mySketch:
    ...
    def get_absolute_axis_data(self, o_axis_data):
        ...
        .. note::
            CAA V5 Visual Basic help
                ...
                | comprises 9 doubles, the first 3 being the coordinates of the axis
                | origin, the next 3 being those of the horizontal axis, and the last 3
                | those of the vertical axis. The sketch horizontal axis is in fact
                | computed from the first non null projection of one of the 3 3D space
                | axes on the sketch plane.  Returns:  oAxisData   The matrix of the
                | axis in 3D space.
                | Example:
                | The following example reads the coordinates
                | of the axis of the sketch mySketch:
    ...
    def open_edition(self):
        ...
        .. note::
            CAA V5 Visual Basic help
                ...
                | 
                | Opens the Sketch Edition. You must open edition on a sketch before you
                | can add  elements in it.  The CATIAFactory2D returned then enables you
                | to create 2D  geometrical elements in the sketch.   Returns:  oFactory
                | Returns the 2D FACTORY. Example:The following example opens edition on
                | the sketch mySketch and places the factory in my2DFactory:  Set
    ...
    def set_absolute_axis_data(self, i_axis_data):
        ...
        .. note::
            CAA V5 Visual Basic help
                ...
                | Parameters:
                | oAxisData
                | 	 The matrix comprises 9 doubles, the first 3 being the coordinates
