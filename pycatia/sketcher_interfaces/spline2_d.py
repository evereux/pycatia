...
class Spline2D(Curve2D):
    ...
    def get_control_points(self, o_ctrl_points=None):
        """
        .. note::
            CAA V5 Visual Basic Help (2020-06-09 09:53:18.676780))
    ...
    def get_number_of_control_points(self):
        ...
        :return: float
        """
        return float(self.spline2_d.GetNumberOfControlPoints())

    def insert_control_point_after(self, i_ctrl_point=None, i_position=None):
        """
        .. note::
            CAA V5 Visual Basic Help (2020-06-09 09:53:18.676780))
        ...
        :return: None
        """
        return self.spline2_d.InsertControlPointAfter(i_ctrl_point, i_position)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
