...
class Noa(AnyObject):
    ...
    def get_modifiable_text(self, i_index: cat_variant) -> AnyObject:
        ...
        :rtype: AnyObject
        """
        return AnyObject(self.noa.GetModifiableText(i_index.com_object))
    ...
    def get_nbr_url(self, o_number_of_url: cat_variant) -> None:
        ...
        :rtype: None
        """
        return self.noa.GetNbrURL(o_number_of_url.com_object)
    ...
    def modify_url(self, i_url: str, i_index: cat_variant) -> None:
        ...
        :rtype: None
        """
        return self.noa.ModifyURL(i_url, i_index.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def remove_url(self, i_index: cat_variant) -> None:
        ...
        :rtype: None
        """
        return self.noa.RemoveURL(i_index.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
