...
class DrawingViewGenerativeBehavior(CATBaseDispatch):
    ...
    # todo: investigate how this works.
    def define_polygonal_detail_view(self, i_profile: tuple,
                                     i_parent_view_generative_behavior: 'DrawingViewGenerativeBehavior') -> None:
        """
        .. note::
            CAA V5 Visual Basic Help (2020-06-11 12:40:47.360445))
    ...
    def define_stand_alone_section(self, profile: tuple, type_of_section: str, type_of_profile: str, i_plane: tuple,
                                   i_side: int) -> None:
        """
        .. note::
            CAA V5 Visual Basic Help (2020-06-11 12:40:47.360445))
