...
class Measurable(AnyObject):
    ...
    def get_axis(self, o_axis_vector: tuple) -> None:
        """
        .. note::
            CAA V5 Visual Basic Help (2020-07-06 14:02:20.222384))
        ...
        :rtype: None
        """
        return self.measurable.GetAxis(o_axis_vector)
        ...
        # # vba_code = """
        # # Public Function get_axis(measurable)
        # #     Dim oAxisVector (2)
        # #     measurable.GetAxis oAxisVector
    ...
    def get_axis_system(self, o_components: tuple) -> None:
        """
        .. note::
            CAA V5 Visual Basic Help (2020-07-06 14:02:20.222384))
        ...
        :rtype: None
        """
        return self.measurable.GetAxisSystem(o_components)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
        ...
        # # vba_code = """
        # # Public Function get_axis_system(measurable)
        # #     Dim oComponents (2)
        # #     measurable.GetAxisSystem oComponents
    ...
    def get_cog(self, o_coordinates: tuple) -> None:
        """
        .. note::
            CAA V5 Visual Basic Help (2020-07-06 14:02:20.222384))
        ...
        :rtype: None
        """
        return self.measurable.GetCOG(o_coordinates)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
        ...
        # # vba_code = """
        # # Public Function get_cog(measurable)
        # #     Dim oCoordinates (2)
        # #     measurable.GetCOG oCoordinates
    ...
    def get_center(self, o_coordinates: tuple) -> None:
        """
        .. note::
            CAA V5 Visual Basic Help (2020-07-06 14:02:20.222384))
        ...
        :rtype: None
        """
        return self.measurable.GetCenter(o_coordinates)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
        ...
        # # vba_code = """
        # # Public Function get_center(measurable)
        # #     Dim oCoordinates (2)
    ...
    def get_direction(self, o_direction: tuple) -> None:
        ...
        :rtype: None
        """
        return self.measurable.GetDirection(o_direction)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
        ...
        # # vba_code = """
        # # Public Function get_direction(measurable)
        # #     Dim oDirection (2)
        # #     measurable.GetDirection oDirection
    ...
    def get_minimum_distance(self, i_measured_item: Reference) -> float:
        """
        .. note::
            CAA V5 Visual Basic Help (2020-07-06 14:02:20.222384))
    ...
    def get_minimum_distance_points(self, i_measured_item: Reference, o_coordinates: tuple) -> None:
        """
        .. note::
            CAA V5 Visual Basic Help (2020-07-06 14:02:20.222384))
        ...
        :rtype: None
        """
        return self.measurable.GetMinimumDistancePoints(i_measured_item.com_object, o_coordinates)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
        ...
        # # vba_code = """
        # # Public Function get_minimum_distance_points(measurable)
        # #     Dim iMeasuredItem (2)
        # #     measurable.GetMinimumDistancePoints iMeasuredItem
    ...
    def get_plane(self, o_components: tuple) -> None:
        """
        .. note::
            CAA V5 Visual Basic Help (2020-07-06 14:02:20.222384))
        ...
        :rtype: None
        """
        return self.measurable.GetPlane(o_components)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
        ...
        # # vba_code = """
        # # Public Function get_plane(measurable)
        # #     Dim oComponents (2)
        # #     measurable.GetPlane oComponents
    ...
    def get_point(self, o_coordinates: tuple) -> None:
        """
        .. note::
            CAA V5 Visual Basic Help (2020-07-06 14:02:20.222384))
        ...
        :rtype: None
        """
        return self.measurable.GetPoint(o_coordinates)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
        ...
        # # vba_code = """
        # # Public Function get_point(measurable)
        # #     Dim oCoordinates (2)
        # #     measurable.GetPoint oCoordinates
    ...
    def get_points_on_axis(self, o_coordinates: tuple) -> None:
        """
        .. note::
            CAA V5 Visual Basic Help (2020-07-06 14:02:20.222384))
        ...
        :rtype: None
        """
        return self.measurable.GetPointsOnAxis(o_coordinates)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
        ...
        # # vba_code = """
        # # Public Function get_points_on_axis(measurable)
        # #     Dim oCoordinates (2)
        # #     measurable.GetPointsOnAxis oCoordinates
    ...
    def get_points_on_curve(self, o_coordinates: tuple) -> None:
        """
        .. note::
            CAA V5 Visual Basic Help (2020-07-06 14:02:20.222384))
        ...
        :rtype: None
        """
        return self.measurable.GetPointsOnCurve(o_coordinates)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
        ...
        # # vba_code = """
        # # Public Function get_points_on_curve(measurable)
        # #     Dim oCoordinates (2)
        # #     measurable.GetPointsOnCurve oCoordinates
    ...
    def __repr__(self):
        return f'Measurable(name="{ self.name }")'
