...
class HybridShapeCircle(HybridShape):
    ...
    def get_axis(self, i_position=None, o_axis=None):
        """
        .. note::
            CAA V5 Visual Basic Help (2020-06-09 09:53:18.676780))
    ...
    def get_center(self, o_center_x=None, o_center_y=None, o_center_z=None):
        """
        .. note::
            CAA V5 Visual Basic Help (2020-06-09 09:53:18.676780))
    ...
    def get_free_center(self, io_center=None):
        """
        .. note::
            CAA V5 Visual Basic Help (2020-06-09 09:53:18.676780))
    ...
    def get_free_radius(self, o_radius=None):
        """
        .. note::
            CAA V5 Visual Basic Help (2020-06-09 09:53:18.676780))
    ...
    def get_limitation(self):
        ...
        :return: int
        """
        return int(self.hybrid_shape_circle.GetLimitation())

    def set_limitation(self, i_limitation=None):
        """
        .. note::
            CAA V5 Visual Basic Help (2020-06-09 09:53:18.676780))
