...
class HybridShapeRollingOffset(HybridShape):
    ...
    def get_nb_curve(self):
        ...
        :return: int
        """
        return int(self.hybrid_shape_rolling_offset.getNbCurve())
    ...
    def get_offset(self):
        ...
        :return: float
        """
        return float(self.hybrid_shape_rolling_offset.getOffset())

    def put_curve(self, i_curve=None):
        """
        .. note::
            CAA V5 Visual Basic Help (2020-06-09 09:53:18.676780))
    ...
    def put_offset(self, i_offset=None):
        """
        .. note::
            CAA V5 Visual Basic Help (2020-06-09 09:53:18.676780))
